...
import com.binmile.test.base.TTBaseTest;
import com.binmile.utils.ExcelReader;
import com.binmile.utils.PropertyFile;
import com.binmile.website.constants.TestConstants;


@Listeners({ com.binmile.listners.TestListner.class })
...
public class TTBaseTest {
	...
	String reportpath=System.getProperty("user.dir")+"/Report/extent_report/"+this.getClass().getSimpleName()+"_"+"ExtentReport"+".html";
...
//			logger.info("Default user password is  ------ "+propertyFile.getProperty("password"));
	...
	public ExtentReports createInstance(String filename) throws Exception
	{
		...
		htmlreport.config().setDocumentTitle("Binmile Technologies Pvt. Ltd.");
		htmlreport.config().setEncoding("utf-8");
		htmlreport.config().setReportName("Binmile Launchpad Automation Report");
